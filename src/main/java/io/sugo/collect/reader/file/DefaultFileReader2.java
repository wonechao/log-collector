...
import io.sugo.collect.writer.file.FileWriter;
 ...
 */
public class DefaultFileReader2 extends AbstractReader {
  private static final String UTF8 = "UTF-8";
  private final Logger logger = LoggerFactory.getLogger(DefaultFileReader2.class);
  ...
  private int maxSize;
  protected Map<String, AbstractWriter> writers;
  //protected AbstractWriter writer;

  public DefaultFileReader2(Configure conf, WriterFactory writerFactory) {
  ...
  private class Reader implements Runnable {
              ...
              if (parser == null){
                ...
                try {
                  ...
                  if (gmMap.size() > 0){
                    ...
                    String day = sdf.format(new Date(Long.parseLong(gmMap.get("DataTime").toString())));
                    if (writers.containsKey(day)){
                      if (writer != writers.get(day)){
                      ...
                      //TODO
                      writers.put(day, ((FileWriter)writerFactory.createWriter()).withFile(day));
                      writer = writers.get(day);
                    }
    ...
    private boolean write(AbstractWriter writer, List<String> messages) throws InterruptedException {
